...
const CardLink = ({ title, subTitle, link, linkText }) => {
    return (
        <Fragment>
            ...
            <div className=" p-6 bg-white border border-gray-300 rounded-lg shadow">
                ...
                <p className="mb-3 font-normal text-gray-500 dark:text-gray-600">{subTitle}</p>
                <a href={link} className="inline-flex items-center dark:text-gray-600 text-blue-600 hover:underline">
                    {linkText}
